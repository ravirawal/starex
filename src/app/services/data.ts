...
export const ROUTE_MATCH = {
  ...
  'blogs': '/blogs',
  'board committees': '/board-commities',
  'campus': '/campus-view',
  ...
  'faq': '/faqs',
  'faqs': '/faqs',
  'function up': '/functionup',
  'functionup': '/functionup',
  'gallery': '/gallery',
  'germany hospitality': '/apprenticeship-training',
  'gym': '/gym',
  'home': '/home',
